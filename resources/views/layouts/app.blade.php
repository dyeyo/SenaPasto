...
<head>
    ...
    <link href="{{asset('materialBoostrapcss/addons/js/datatables-select.css') }}" rel="stylesheet">
    <!-- DataTables Select CSS -->
    <script href="{{asset('materialBoostrapcss/addons/js/datatables-select.js') }}" rel="stylesheet"></script>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('juicios') }}">Juicios Evaluativos</a>
                            </li>
